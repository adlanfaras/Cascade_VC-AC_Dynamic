...
def main() -> None:
    ...
    print(f"  NH3 compressor duty  : {last['w_ref_comp_w'] / 1000.0:.2f} kW")
    print(f"  NH3 superheat        : {last['refrigerant_superheat_k']:.2f} K")
    print(f"  NH3 compressor speed : {last['refrigerant_compressor_speed_rpm']:.1f} rpm")
    ...
    print(f"  Air massflow         : {last['m_air_kg_s']:.4f} kg/s")
