...
- Identification plots: `outputs\lpr_nh3_siso_step_response_tuning_refprop_smoke2` with suffix `_identification.png`.
- Publication-style Ziegler-Nichols reaction-curve panels: `outputs\lpr_nh3_siso_step_response_tuning_refprop_smoke2` with suffix `_zn_reaction_curve.png`.
- Numeric summary: `outputs\lpr_nh3_siso_step_response_tuning_refprop_smoke2\lpr_siso_step_response_tuning_summary.csv`.
